...
import os
import time
from config import products, users, name_dayincome, income_tax, after_tax,         name_transactions, disc0, disc1, pin, pin_enabled, pin_tries, tax_percentage, command_end
