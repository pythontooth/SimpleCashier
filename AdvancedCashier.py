...
try:
    ...
    print("Error: config.py file not found. Please download the config.py file and place it in the same directory as this script.")
...
def login():
    ...
    for name, number in users.items():
        ...
        elif str(selected_number).lower() == "exit":
            cls()
            input("Press Enter to close the program...")
            sys.exit()
